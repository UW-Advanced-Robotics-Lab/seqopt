...
class SequenceSAC(object):
    ...
    def add_option(self,
                   ...
                   terminator_params: TerminatorParams,
                   exploration_params: Optional[ExplorationParams] = None) -> None:
    ...
    def collect_rollouts(self,
        ...
        while total_steps < n_steps or total_episodes < n_episodes:
            ...
            if self.state_visit_counters[active_option] is not None:
                # Get the current count
                count = self.state_visit_counters[active_option].get_counts(curr_obs_tensor).cpu().numpy()
                intrinsic_reward = self.exploration_reward_scales[active_option] / np.sqrt(count)
